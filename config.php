...
define("TIT1", 'Двери Вектор');

//параметры подключения к БД
define("DB_URL", 'mysqli://u1264929_bd07dv:OeSijo1yZ@localhost/u1264929_bd07dv');
...
define("ADMIN_FOLDER", 'adminka07dv');
...
define("FTP_LOGIN", 'sozdatel');

//пароль FTP-пользователя
define("FTP_PASSWORD", 'DEdMDuMQwhNLk8S0Q69a');
