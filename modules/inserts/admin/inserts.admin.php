...
class Inserts_admin extends Frame_admin
{
	...
	public $variables = array (
		'main' => array (
			'name' => array(
				'type' => 'text',
				'name' => 'Название',
				'help' => 'Название вставки, любое имя.',
			),
			'act' => array(
				'type' => 'checkbox',
	...
	public function show()
	{
		...
		// 	return;
		// }
		echo '<p>'.$this->diafan->_('Модуль вставок служит для переопределения или дополнения используемых на сайте шаблонных тегов. %sПодробнее в документации%s.', '<a href="http'.(IS_HTTPS ? "s" : '').'://www.diafan.ru/dokument/full-manual/sysmodules/inserts/">', '</a>').'</p>';
