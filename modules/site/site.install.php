...
class Site_install extends Install
{
	...
	public $sql = array(
		...
		"site_theme" => array(
			array(
				"name" => 'phone',
				"value" => array('495 567-09-12', '495 567-09-12'),
				"type" => "phone",
			),
			array(
				"name" => 'contacts',
				"value" => array('г. Москва, ул. Людвига Великого,<br>д. 12, стр. 1, офис 12<br>Тел.: 8 495  121-21-12<br>E-mail: info@demosite.ru', 'Moscow, Ludwig the Great st.,<br>b. 12/1, office 12 <br> Tel.: 8495 121-21-12<br>E-mail: info@demosite.ru'),
				"type" => "text",
			),
			array(
				"name" => 'delivery',
				"value" => array('<p>Доставка бесплатная*<br>*до 3000 - 300 рублей</p>', '<p>Delivery is free*<br>*less 3000 - 300 rubles</p>'),
				"type" => "editor",
			),
			array(
				"name" => 'return',
				"value" => array('<p>14 дней возврат/обмен<br> 2 года гарантия</p>', '<p>14 days return/change<br> 2 years warranty</p>'),
				"type" => "editor",
			),
			array(
				"name" => 'show_favorite',
