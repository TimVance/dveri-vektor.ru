...
if ($result)
{
	if(! empty($result["more"]))
	{
		...
		echo '<div class="paginator_more text-center mt-5">'
				.'<input type="submit" value="'.$result["more"]["name"].'" class="paginator_more_button btn_bord b_white js_paginator_more_button">'
			.'</div>';
