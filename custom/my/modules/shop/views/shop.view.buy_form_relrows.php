...
echo '
<form method="post" action="" class="ajax d-flex js_shop_form shop_form">
...
{
	echo '<div class="d-none addict-field col-12 mb-3">';
...
echo '<div class="d-flex js_shop_buy shop_buy to-cart">';
...
{
	echo '<span class="js_shop_one_click shop_one_click d-none"><input type="button" value="'.$this->diafan->_('Купить в один клик', false).'" action="one_click"></span>';
}
