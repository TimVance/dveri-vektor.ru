...
class Shop_admin_discount extends Frame_admin
{
	...
	*/
	 ...
	 */
	// public $where = " AND no_auth='0' AND role_id=0 AND person='0' AND threshold=0 AND threshold_cumulative=0 AND threshold_goods=0 AND threshold_count=0 AND delivery_id=0 AND payment_id=0 AND c.coupon IS NULL";
	public $where = " AND `variable`='goods'";
	...
	public $variables = array (
		'main' => array (
			...
			'deduction' => array(
				'type' => 'floattext',
				'name' => 'Размер скидка в виде фиксированной суммы',
	...
	private function show_content_h1()
	{
		...
		$this->diafan->_admin->name = 'Постоянные скидки на товары';
	}
	...
	private function show_variable_discount()
	{
		...
		<div class="tabs" id="mode_express">
			<a href="'.$url.$site.'" class="tabs__item tabs__item_active">'.$this->diafan->_('На товары').'</a>
