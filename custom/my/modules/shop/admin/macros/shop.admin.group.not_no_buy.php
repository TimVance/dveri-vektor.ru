<?php
/**
 * Макрос для групповой операции: товар в наличии
 * 
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
/**
 * Shop_admin_group_not_no_buy
 */
class Shop_admin_group_not_no_buy extends Diafan
{
	/**
	...
	/**
	 * Снимает пометку у товаров об отсутствии
	 *
	 * @return void
	 */
	public function action()
	{
		...
		if(! empty($ids))
		{
			DB::query("UPDATE {shop} SET no_buy='0' WHERE id IN (%s)", implode(",", $ids));
