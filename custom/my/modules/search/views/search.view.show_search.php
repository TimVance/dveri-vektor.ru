...
<div class="search">
	...
	<input type="text" name="searchword" value="'.($result["value"] ? $result["value"] : '').'" placeholder="'.$this->diafan->_('Поиск по сайту', false).'" class="input_search w-100">
	<input type="submit" value="Найти" class="submit_search mx-auto d-block mb-3">
	</form>';
if($result["ajax"])
{
